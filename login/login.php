...
<html lang="pt-br">
    ...
    <body>
        ...
        <form 
            ...
            action="../loginRedirect/loginRedirect.php"
            method="post"
        >
            <?php
                include("../userInfoInputs/userInfoInputs.php");
            ?>

            <input id="userInfoSubmitInput" class="yellowInteractable" type="submit" value="Fazer Login"><br>
